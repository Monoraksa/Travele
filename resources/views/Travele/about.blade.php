	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{env('about.blade.php')}}" class="nav-link">About</a></li>
	          <li class="nav-item"><a href=="{{env('destination.blade.php')}}" class="nav-link">Destination</a></li>
	          <li class="nav-item"><a href="{{env('hotelresto.blade.php')}}" class="nav-link">Hotels &amp; Restaurant</a></li>
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-self-stretch" style="background-image:url(images/ba12.jpg);"></div>
    			</div>
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 order-md-last d-flex">
    				<div class="img d-flex align-self-stretch" style="background-image:url(images/t11.jpg);"></div>
    			</div>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center">
            <div class="col-md-10 text-wrap text-center heading-section ftco-animate">
              <h2>Become Our VIP Membership Now !</h2>
