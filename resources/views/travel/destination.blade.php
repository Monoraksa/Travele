          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
    		...
    		<div class="row">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
    					<div class="img">
		    				<img src="images/{{$place->image}}" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="text">
							<!-- {{-- link redirect to route booking china --}} -->
	    					<h4 class="price"><a href="/book/{{$place->id}}">${{$place->price}}</h4> 
	    					<span>{{$place->duration}} Days Tour</span>
	    					<h3><a href="{{ url('/bookchina') }}">{{$place->place_name}}</h3>
